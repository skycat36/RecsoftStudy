...
<@c.page>
    ...
    <div class="form-group row">
        <h1><label class="col-ml-2 col-form-label"></label></h1>
    </div>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="text" name="login" value="<#if userTemp??>${userTemp.name}</#if>"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="password" name="password" value="<#if userTemp??>${userTemp.password}</#if>"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="text" name="secName" value="<#if userTemp??>${userTemp.name}</#if>"
                       class="form-control small ${(nameError??)?string('is-invalid', '')}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="email" name="email" value="<#if userTemp??>${userTemp.name}</#if>"
        ...
        <div class="form-group row">
                <div class="col-sm-1 mr-4"><button type="submit" class="btn btn-primary ml-0">Отправить</button></div>
